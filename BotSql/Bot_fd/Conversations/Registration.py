...
class RegistrationConversation:
    ...
    def start_registration(self, update, context):
        ...
        if user_sql_info_tuple:
            ...
            update.message.reply_text(
                f'Ваш профиль уже зарегистрирован в \U0001F393Клубе выпускников.\n\n'
            ...
            update.message.reply_text(
                ...
                f'\U0001F468\U0001F3FB\U0000200D\U00002696\U0000FE0F \U0001F469\U0001F3FB\U0000200D\U00002696\U0000FE0FПол\n'
                f'Фамилия\n'
                f'Имя\n'
                f'Отчество\n'
    ...
    def reg_institute(self, update, context):
        ...
        # Разговор
        update.message.reply_text(
            'Укажите свое текущее место работы, либо оставьте прочерк (необязательно):',  # !
        )
    ...
    def reg_position(self, update, context):
        ...
        if user_sql_info_tuple:
            # Разговор
            update.message.reply_text(
                'Клуб выпускников благодарит Вас, что поделились информацией о себе.\n'
                'Чтобы продолжить работу с ботом нажмите \U000025B6/start.',  # !
            )
        else:
            update.message.reply_text(
                f'К сожалению, нам не удалось зарегистрировать Вас в \U0001F393Клубе выпускников '
                f'\U00002696Факультета права из-за технической ошибки.\n'
                f'Обратитесь, пожалуйста, напрямую в \U0001F393Клуб выпускников \U00002696Факультет права НИУ ВШЭ:\n'
