...
class ConversationBot:
    ...
    def start(self, update, context):
        ...
        update.message.reply_text(
            ...
            f'Вас приветствует официальный бот \U0001F393Ассоциации выпускников  \U00002696Факультета права '
            ...
            f'Ассоциации выпускников \U0001F393 оставаться на связи \U0001F4DE \U0001F4E9 с Вами '
